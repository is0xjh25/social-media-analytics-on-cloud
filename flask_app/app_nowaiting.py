...
def my_view_function():
    ...
    def data_retirieving_task():
        from flask import Flask, request, render_template, json, jsonify, redirect
        from plotly.utils import PlotlyJSONEncoder
        import plotly.graph_objects as go
        import json

        view_result = db.view("_design/gcc-doc/_view/gcc-view", reduce=True, group=True)
    ...
    # Query the view
    thread = threading.Thread(target=data_retirieving_task)
    thread.start()
